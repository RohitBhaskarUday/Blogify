    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try(PrintWriter out = resp.getWriter()){
            ...
            String jsonPayload = String.format(
                    "{\"prompt\": \" Enhance the following content by improving sentence structure, grammar and clarity. Do not add personal opinions, disclaimers, or extra commentary. Only return the improved text and nothing else. Here is the original text: %s\", \"model\": \"llama3.2\"}",
                    content.replace("\"", "\\\""));
